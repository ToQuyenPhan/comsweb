    ...
    return (
        <aside>
            <nav className='side-nav'>
                ...
                <ul>
                    <li>
                        <a href="javascript:;" className={"side-menu " + ((url === "/user" || 
                            url === "/create-user") ? "side-menu--active" : "")}>
                            <div className="side-menu__icon"><Icon icon="lucide:users" color={((
                                    url === "/user" || url === "/create-user") 
                        ...
                        <ul className={"" + ((url === "/user" || url === "/create-user") ? "side-menu__sub-open" : "")}>
                            <li>
                                <a href="/user" className={"side-menu " + (url === "/user" ?
                                    "side-menu--active" : "")}>
                                    <div className="side-menu__icon"> <Icon icon="lucide:list" className='icon' /> </div>
                                    <div className="side-menu__title"> View Users </div>
                                </a>
                            </li>
                            <li>
                                <a href="/create-user" className={"side-menu " + (url === "/create-user" ?
                                    "side-menu--active" : "")}>
                                    <div className="side-menu__icon"> <Icon icon="lucide:user-round-plus" className='icon' /> </div>

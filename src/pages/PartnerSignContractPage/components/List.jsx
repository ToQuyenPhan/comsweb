...
function List() {
    ...
    const fetchContractData = async () => {
        let url = `https://quanlyhopdong-be.hisoft.vn/Contracts/partner?DocumentStatus=5&IsApproved=true&CurrentPage=1&PageSize=10`;
        if (searchName !== null) {
    ...
    const fetchNext = async () => {
        ...
        const res = await fetch(`https://quanlyhopdong-be.hisoft.vn/Contracts/partner?DocumentStatus=5&IsApproved=true&CurrentPage=${currentPage + 1}&pageSize=10`, {
            mode: 'cors',
            method: 'GET',
            headers: {
                Authorization: `Bearer ${token}`,

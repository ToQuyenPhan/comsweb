...
function List() {
  ...
  const [contractAnnexName, setContractAnnexName] = useState("");
  ...
  const handleContractNameChange = (e) => {
    setContractAnnexName(e.target.value);
  };
  ...
  return (
    <div className="contract-annex-list">
      <h2 className="intro-y">Contract Annex List</h2>
      <div>
          ...
          <div>
            <div>
              ...
              <input
                ...
                placeholder="Contract annex name..."
                value={searchByName}
                ...
                <tr className="intro-x" id={contractAnnex.id}>
                  ...
                  <div>
                      <Icon
                        ...
                        className="icon"
                        onClick={() => openOptionMenu(contractAnnex.id)}
                      />
                      {parseInt(jwtDecode(token).id) === contractAnnex?.creatorId ? (
                        <div id={"option-menu-" + contractAnnex.id}>
                          <ul className="dropdown-content">
                            <li>
                              ...
                              >
                                {" "}
                                <Icon icon="lucide:eye" className="icon" /> View
                                Details{" "}
                              </a>
                            </li>
                            {/* <li>
                              <a
                                href="javascript:;"
                                className="dropdown-item"
                                onClick={() => handleEditClick(contractAnnex.id)}
                              >
                                {" "}
                                <Icon
                                  icon="bx:edit"
                            ...
                            <li>
                              <a
                                href="javascript:;"
                                className="dropdown-item"
                                onClick={() => handleDeleteClick(contractAnnex.id)}
                              >

...
function FlowDetails() {
  ...
  const fetchComments = async () => {
    try {
      const response = await fetch(
        `https://localhost:7073/Comments/annex?contractAnnexId=${contractAnnexId}`,
        {
          mode: "cors",
          method: "GET",
          headers: new Headers({
  ...
  const fetchFlowDetailData = async () => {
    try {
      const response = await fetch(
        `https://localhost:7073/UserFlowDetails/annex?ContractAnnexId=${contractAnnexId}&CurrentPage=1&PageSize=4`,
        {
          mode: "cors",
          method: "GET",
          headers: new Headers({
  ...
  const fetchNext = async () => {
    ...
    const res = await fetch(`https://localhost:7073/UserFlowDetails/annex?ContractAnnexId=${contractAnnexId}&CurrentPage=${currentPage + 1}&pageSize=4`, {
      mode: 'cors',
      method: 'GET',
      headers: {
        Authorization: `Bearer ${token}`,
  ...
  const fetchPartnerComment = async () => {
    try {
      const response = await fetch(
        `https://localhost:7073/PartnerComments/annex?contractAnnexId=${contractAnnexId}`,
        {
          mode: "cors",
          method: "GET",
          headers: new Headers({
  ...
  const handleApprove = async () => {
    try {
      ...
      const res = await fetch(
        `https://localhost:7073/ContractAnnexes/approveOrReject?id=${contractAnnexId}&isApproved=true`,
        {
          mode: "cors",
          method: "PUT",
          headers: new Headers({
          ...
          if (result.isConfirmed) {
            ...
            if (text) {
              try {
                ...
                const res = await fetch(
                  `https://localhost:7073/ContractAnnexes/approveOrReject?id=${contractAnnexId}&isApproved=false`,
                  {
                    mode: "cors",
                    method: "PUT",
                    headers: new Headers({
                ...
                if (res.status === 200) {
                  let url = `https://localhost:7073/Comments/annex`;

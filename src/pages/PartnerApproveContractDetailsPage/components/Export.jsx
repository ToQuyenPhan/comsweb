  ...
  const handleApproveClick = async () => {
    try {
      ...
      const res = await fetch(
        `https://quanlyhopdong-be.hisoft.vn//PartnerReviews/approveOrReject?contractId=${contractId}&isApproved=true`,
        {
          mode: "cors",
          method: "PUT",
          headers: new Headers({
          ...
          try {
            ...
            if (res.status === 200) {
              const res2 = await fetch(
                `https://quanlyhopdong-be.hisoft.vn//PartnerReviews/approveOrReject?contractId=${contractId}&isApproved=false`,
                {
                  mode: "cors",
                  method: "PUT",
                  headers: new Headers({
              ...
              if (res2.status === 200) {
                const res3 = await fetch(
                  `https://quanlyhopdong-be.hisoft.vn//Contracts/reject?id=${contractId}&isApproved=false`,
                  {
                    mode: "cors",
                    method: "PUT",
                    headers: new Headers({

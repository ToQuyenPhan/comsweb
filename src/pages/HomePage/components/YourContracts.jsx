...
function YourContracts() {
    ...
    const fetchContractData = async () => {
        let url = `https://quanlyhopdong-be.hisoft.vn/Contracts/yours?CurrentPage=1&pageSize=5&IsYours=true`;
    ...
    const fetchNext = async () => {
        ...
        const res = await fetch(`https://quanlyhopdong-be.hisoft.vn/Contracts/yours?CurrentPage=${currentPage + 1}&pageSize=5&IsYours=true`, {
            mode: 'cors',
            method: 'GET',
            headers: {
                Authorization: `Bearer ${token}`,
    ...
    const handleKeyDown = async (e) => {
        if (e.key === 'Enter') {
            let url = `https://quanlyhopdong-be.hisoft.vn/yours?CurrentPage=1&PageSize=5&ContractName=${searchByName}&IsYours=true`;
            const res = await fetch(url, {
                mode: 'cors',
                method: 'GET',
                headers: {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        let url = `https://quanlyhopdong-be.hisoft.vn/Contracts/yours?CurrentPage=1&PageSize=5&ContractName=${contractName}&IsYours=true`;
